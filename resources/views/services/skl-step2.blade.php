...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="w-full max-w-md bg-white shadow-lg rounded-lg p-6">
        <h2 class="text-2xl font-bold mb-6 text-center">SKL - Step 2</h2>
        <form action="{{ route('service.submit', ['service' => 'skl', 'step' => 2]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <input type="hidden" name="user_id" value="{{ request('user_id') }}">
            <div class="mb-4">
                <label for="nama_pelahir" class="block text-gray-700">Nama Anak</label>
                <input type="text" name="nama_pelahir" id="nama_pelahir" required class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
            </div>
            <div class="mb-4">
            ...
            <div class="mb-4">
                <label for="pembantu_lahir" class="block text-gray-700">Pembantu Pelahiran</label>
                <select name="pembantu_lahir" id="pembantu_lahir" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
            ...
            <div class="mb-4">
                <label for="ktp" class="block text-gray-700">Upload KTP Orang Tua:</label>
            ...
            <div class="mb-4">
                <label for="kk" class="block text-gray-700">Upload KK Keluarga:</label>
